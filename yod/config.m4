...
if test "$PHP_YOD" != "no"; then
	...
	ext_files="yod.c yod_application.c yod_request.c yod_controller.c yod_action.c yod_widget.c yod_server.c yod_client.c yod_model.c yod_database.c yod_dbpdo.c yod_plugin.c yod_base.c"
